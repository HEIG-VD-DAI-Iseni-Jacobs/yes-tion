...
public class AuthController {
    ...
    public void login(Context ctx) {
        String email = ctx.bodyValidator(LoginRequest.class)
     ...
     * GET /profile
     * Réponses :
     *   200 : renvoie l'utilisateur (JSON)
     *   401 : si le cookie "user" est manquant ou ne correspond à aucun utilisateur
     */
